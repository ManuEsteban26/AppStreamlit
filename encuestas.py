    ...
    try:
        ...
        if tabla == "Cuestionario_BC":
            ...
            if result.data:
                ...
                return False
        elif tabla == "Cuestionario_Obra_Gris":
        ...
        elif tabla == "Cuestionario_Comunidad":
...
def main():
    ...
    if st.session_state.current_page == 'home':
        show_home()
    elif st.session_state.current_page == 'bc':
        show_survey_bc()
    elif st.session_state.current_page == 'obra_gris':
        show_survey_obra_gris()
    elif st.session_state.current_page == 'comunidad':
...
def show_home():
    ...
    with col1:
        if st.button("🏢 Business Center", use_container_width=True, type="primary"):
            st.session_state.current_page = 'bc'
            st.rerun()
            
    with col2:
        if st.button("🚧 Obra Gris", use_container_width=True, type="primary"):
            st.session_state.current_page = 'obra_gris'
            st.rerun()
            
    with col3:
        if st.button("👥 Comunidad", use_container_width=True, type="primary"):
            st.session_state.current_page = 'comunidad'
            st.rerun()
