...
def show_survey_motorola():
    ...
    JEFES = [
        ...
        "ANDRES ORLANDO CUBIDES FRANCO",
        "ANGEL ALBERTO CHARRY GARRIDO",
        "ANGIE DANIELA PRIETO VELASQUEZ",
        "ANUAR JAVIER CONTRERAS OLIVERA",
        "BEATRIZ ELENA MORALES MARTINEZ",
        "CAROLINA MARIN",
        "CESAR MURIEL DURAN",
        "CRISTHIAN CAMILO PENAGOS MONTAÑO",
        "DIDIER GONZALEZ ARISTIZABAL",
        "EDINSON ENRIQUE OLIVEROS ALVARADO",
        "EDISON JULIAN MEDINA SANABRIA",
        "GINETH MANTILLA HENAO",
        "GUSTAVO ADOLFO CALVO RESTREPO",
        "IRIANA MARCELA VILLARREAL MEDRANO",
        "IVAN CAMILO AVILA SALCEDO",
        "JAVIER JIMENEZ",
        "JEIMY CAROLINA SALAMANCA PORRAS",
        "JESUS LEANDRO VALERO DIAZ",
        "JOCELINE YESENIA MAYA CUELTAN",
        "JORGE ELIECER OROZCO BOCANEGRA",
        "JULIAN CAMILO DIAZ RUIZ",
        "JULIE HASBLEIDY GONZALEZ ROMERO",
        "KATHERINNE MARGEDYS PEÑA RAMIREZ",
        "KEVIN ANDRES TORRES JIMENEZ",
        "LINA MARIA GONZALEZ",
        "MARÍA SHIRLEY QUINTERO ROJAS",
        "OSCARDY MOLINA ESPINOSA",
        "ROOSVELT ALEXANDER SANCHEZ CARO",
        "SAMUEL RUIZ PINZON",
        "SERGIO ARTURO ROLDAN RUIZ",
        "SILVIA ISABEL ROJAS SANCHEZ",
        "TANIA AGUILAR",
        "YESSICA ANDREA FONSECA LARA",
        "YUDI MILENA PIÑEROS GARCIA"
    ]
